...
1. **Signup**
   ...
   - Details stored securely in `localStorage`
...
3. **Exam Page**
   ...
   - Displays MCQ questions dynamically
   - Calculates score automatically on submission

4. **Logout**
   - Clears session
   - Prevents unauthorized access using route protection
